...
open class FoundationStream : NSObject, WSStream, StreamDelegate  {
    ...
    @objc let BUFFER_MAX = 4096
	
	@objc public var enableSOCKSProxy = false
    ...
    @objc public func write(data: Data) -> Int {
...
open class WebSocket : NSObject, StreamDelegate, WebSocketClient, WSStreamDelegate {
    ...
    @objc public static let ErrorDomain = "WebSocket"
    ...
    @objc let headerWSUpgradeName     = "Upgrade"
    @objc let headerWSUpgradeValue    = "websocket"
    @objc let headerWSHostName        = "Host"
    @objc let headerWSConnectionName  = "Connection"
    @objc let headerWSConnectionValue = "Upgrade"
    @objc let headerWSProtocolName    = "Sec-WebSocket-Protocol"
    @objc let headerWSVersionName     = "Sec-WebSocket-Version"
    @objc let headerWSVersionValue    = "13"
    @objc let headerWSExtensionName   = "Sec-WebSocket-Extensions"
    @objc let headerWSKeyName         = "Sec-WebSocket-Key"
    @objc let headerOriginName        = "Origin"
    @objc let headerWSAcceptName      = "Sec-WebSocket-Accept"
    @objc let BUFFER_MAX              = 4096
    @objc let FinMask: UInt8          = 0x80
    @objc let OpCodeMask: UInt8       = 0x0F
    @objc let RSVMask: UInt8          = 0x70
    @objc let RSV1Mask: UInt8         = 0x40
    @objc let MaskMask: UInt8         = 0x80
    @objc let PayloadLenMask: UInt8   = 0x7F
    @objc let MaxFrameSize: Int       = 32
    @objc let httpSwitchProtocolCode  = 101
    @objc let supportedSSLSchemes     = ["wss", "https"]
    ...
    @objc public var onDisconnect: ((Error?) -> Void)?
    @objc public var onText: ((String) -> Void)?
    @objc public var onData: ((Data) -> Void)?
    @objc public var onPong: ((Data?) -> Void)?

    @objc public var disableSSLCertValidation = false
    @objc public var overrideTrustHostname = false
    @objc public var desiredTrustHostname: String? = nil

    @objc public var enableCompression = true
    #if os(Linux)
    #else
    public var security: SSLTrustValidator?
    @objc public var enabledSSLCipherSuites: [SSLCipherSuite]?
    #endif
    ...
    @objc public var request: URLRequest //this is only public to allow headers, timeout, etc to be modified on reconnect
    @objc public var currentURL: URL { return request.url! }

    @objc public var respondToPingWithPong: Bool = true
    ...
    @objc public convenience init(url: URL, protocols: [String]? = nil) {
    ...
    @objc public convenience init(url: URL, writeQueueQOS: QualityOfService, protocols: [String]? = nil) {
    ...
    */
     ...
     */
    @objc open func write(string: String, completion: (() -> ())? = nil) {
        guard isConnected else { return }
    ...
    /**
     ...
     - parameter completion: The (optional) completion handler.
     */
    @objc open func write(data: Data, completion: (() -> ())? = nil) {
        guard isConnected else { return }
     ...
     */
    @objc open func write(ping: Data, completion: (() -> ())? = nil) {
        guard isConnected else { return }
    ...
    /**
     ...
     Respond to a Yodel.
     */
    @objc open func write(pong: Data, completion: (() -> ())? = nil) {
        guard isConnected else { return }
    ...
    @objc public func newBytesInStream() {
        processInputStream()
    }
    
    @objc public func streamDidError(error: Error?) {
     ...
     */
    @objc func processExtensionHeader(_ extensionHeader: String) {
